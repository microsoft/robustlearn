...
def act_param_init(args):
    args.act_dataset = ['dsads']
    args.act_people = {'dsads': [[i*2, i*2+1] for i in range(4)]}
    tmp = {'dsads': ((45, 1, 125), 19)}
...
def get_args():
    ...
    parser.add_argument('--normstyle', type=str,
                        default='avg', choices=['max', 'avg'])
