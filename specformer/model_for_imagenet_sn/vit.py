...
default_cfgs = {
    ...
    'vit_small_patch16_224.augreg_in21k': _cfg(
        # url="https://drive.google.com/u/0/uc?id=1lXkP533DaQYmpQPF6Pkr0hqYWEuHP6Lx&export=download",
    ...
    'vit_base_patch16_224_in21k_sn': _cfg(
...
class Attention(nn.Module):
    def __init__(self, dim, num_heads=8, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0.,pen_for_qkv=None):
        super().__init__()
    ...
    def calculate_per_head(self,W,i):
        W=W.reshape(W.shape[0],self.num_heads,-1)
...
class Block(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
        ...
        self.attn = Attention(
            dim, num_heads=num_heads, qkv_bias=qkv_bias, qk_scale=qk_scale, pen_for_qkv=pen_for_qkv,attn_drop=attn_drop, proj_drop=drop)
...
def vit_small_patch16_224_sn(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer('vit_small_patch16_224_sn', pretrained=pretrained, **model_kwargs)
    return model

def vit_small_patch16_224_in21k_sn(pretrained=False, **kwargs):
    """ My custom 'small' ViT model. Depth=8, heads=8= mlp_ratio=3."""
    model_kwargs = dict(
         embed_dim=768, depth=8, num_heads=8, mlp_ratio=3.,
        qkv_bias=False, norm_layer=nn.LayerNorm, **kwargs) 
    if pretrained:
        # NOTE my scale was wrong for original weights, leaving this here until I have better ones for this model
        model_kwargs.setdefault('qk_scale', 768 ** -0.5)
    model = _create_vision_transformer('vit_small_patch16_224.augreg_in21k', pretrained=pretrained, **model_kwargs)
    return model



def vit_base_patch16_224_sn(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    model_kwargs = dict( embed_dim=768, depth=12, num_heads=12, **kwargs) #patch_size=16,
    model = _create_vision_transformer('vit_base_patch16_224_sn', pretrained=pretrained, **model_kwargs)
    return model
...
def vit_base_patch16_224_in21k_sn(pretrained=False, **kwargs):
    """ ViT-Base model (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-21k weights @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    model_kwargs = dict(
        patch_size=16, embed_dim=768, depth=12, num_heads=12, representation_size=768, **kwargs)
    model = _create_vision_transformer('vit_base_patch16_224_in21k_sn', pretrained=pretrained, **model_kwargs)
    return model
